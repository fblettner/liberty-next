...
// the connector builder, Phase 7), so all the other basic languages /
// JSON-CSS-HTML-TS modes are left out. Vite turns `?worker` into a separate
// worker bundle; only the core editor worker is needed.
