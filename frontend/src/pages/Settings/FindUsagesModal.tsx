...
const TYPE_TITLES: Record<string, string> = {
  ...
  column_group_update_query: 'Column groups (update query)',
  column_group_insert_query: 'Column groups (insert query)',
  column_group_delete_query: 'Column groups (delete query)',
