...
const fr: Resources = {
  ...
  nomaflow: {
    ...
    editor: {
      ...
      readOnlyNotice: 'Vue en lecture seule — l\'éditeur structuré arrive au prochain incrément.',
      newPlaceholder: '// Une tâche vierge — l\'éditeur structuré arrive au prochain incrément.',
    },
  },
  settings: {
    title: 'Configuration',
