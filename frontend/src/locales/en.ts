...
const en = {
  ...
  nomaflow: {
    ...
    editor: {
      ...
      readOnlyNotice: 'Read-only view — the structured editor lands in the next increment.',
      newPlaceholder: '// A blank job — the structured editor lands in the next increment.',
    },
  },
  settings: {
    title: 'Configuration',
