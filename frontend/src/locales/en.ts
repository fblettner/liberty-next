...
const en = {
  ...
  settings: {
    ...
    theme: {
      intro: 'Brand the whole install — pick a preset palette, set the primary accent colour, and name the app. Applies to every user; dark/light stays an individual choice.',
      preset: 'Preset',
